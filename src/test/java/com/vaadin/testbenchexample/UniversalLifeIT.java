...
public class UniversalLifeIT extends BaseLoginTest {
	...
	public void addSuspense() throws InterruptedException {
		...
		getPolicy.searchByPolicy().sendKeys( "01N1526783" );
		getPolicy.searchButton().click();
		getPolicy.family().getCell( "01N1526783" ).click();
		...
		suspenseSource.suspenseAmount().sendKeys( "75" );
		Assertions.assertEquals( "75",suspenseSource.suspenseAmount().getValue() );
